...
-   **创建子账号**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6219/156626649447465_zh-CN.png)

-   **为子账号生成AccessKey ID、Access Key Secret**

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6219/156626649547466_zh-CN.png)

-   **为子账号授权云监控权限**

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6219/156626649547474_zh-CN.png)
...
3.  选择需要上报数据的子账号，在操作中单击**添加权限** 。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6219/156626649547475_zh-CN.png)

4.  在添加权限页面中，选择**管理云监控的权限**，并单击**确定**保存授权即可。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/6219/156626649547476_zh-CN.png)
